...
// 집합 A가 n번 물건을 포함한다면 A는 n-1번까지의 물건들 중에서 최적으로 고른 부분집합에 n번 물건을 포함한 것과 같다 => maxVSum[n][k] = Math.max(maxVSum[n-1][k], maxVSum[n-1][k-weight] + value)
// 집합 A가 n번 물건을 포함하지 않는다면 A는 n-1번까지의 물건들 중에서 최적으로 고른 부분집합과 같다 => maxVSum[n][k] = maxVSum[n-1][k]
